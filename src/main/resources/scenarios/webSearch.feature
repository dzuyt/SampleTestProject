...
Feature: Google Search
  ...
  Scenario: Search Google
    ...
    When I search for "Quantum-Starter-Kit"
    Then it should have "Quantum-Starter-Kit" in search results
  ...
  Scenario Outline: Search Keyword CSV Data
    ...
    Examples: {'datafile' : 'src/main/resources/data/testData.csv'}
      ...
      @WebDDxls
  Scenario Outline: Search Keyword xls Data
    Given I am on Google Search Page
    When I search for "<searchKey>"
    Then it should have "<searchResult>" in search results
    ...
    Examples: {'datafile' : 'src/main/resources/data/testData.xls'}
      ...
      @WebDDjson
  Scenario Outline: Search Keyword json Data
    Given I am on Google Search Page
    When I search for "<searchKey>"
    Then it should have "<searchResult>" in search results
